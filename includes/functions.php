    ...
    <body>
        <header class="top-nav">
            <nav>
                ...
                <a href="<?= $basePath ?>/cart.php">Cart (
                    <?= $cartCount ?> items -
                    <?= $cartTotal ?> SAR)
                </a>
                <a href="<?= $basePath ?>/contact.php">Contact Us</a>
                <?php if (!empty($_SESSION['admin'])): ?>
                    <a href="<?= $basePath ?>/admin/admin_dashboard.php">Admin:
                        <?= htmlspecialchars($_SESSION['admin_name'] ?? 'Manager') ?>
                    </a>
    ...
    ?>
        ...
        <footer class="site-footer">
            <div class="footer-content">
                <p><strong>Online Shop</strong> - Your friendly local store for furniture and home goods.</p>
                <p>Contact us at <a href="mailto:support@onlineshop.local">support@onlineshop.local</a> for help and
                    questions.</p>
